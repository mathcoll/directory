...
(function() {
	...
	appshell.setLayout('IoT Directory');
	...
	1: [function(e, t, n) {
		...
		var i = function() {
			...
			return r(e, [{
				...
				value: function(e) {
					var t = this;
						console.log("onStart: ", e), this.loader.classList.remove("is-hidden"), this.updateNavDrawer(e), fetch("/home" + e).then(function(e) {
						...
						div.setAttribute("class", "card-header card-header-primary");
						
						var h4 = document.createElement("h4");
						h4.setAttribute("class", "card-title mt-0");
						h4.textContent = "Title";
						div.appendChild(h4);
						var p = document.createElement("p");
						p.setAttribute("class", "card-category");
						p.textContent = "Description of content"
						div.appendChild(p);
						
						var div_body = document.createElement("div");
						div_body.setAttribute("class", "card-body");
						var div_content = document.createElement("div");
						div_content.setAttribute("class", "tab-content");
						...
						var list = "<ul>" +
			                    ...
			                    "            </label>" +
			                    "       </div>";
						var t = JSON.parse(e).json;
						[].forEach.call(t, function(d) {
							console.log("DEBUG");
						...
						div_content.appendChild(parser.parseFromString(list, "text/html").body.firstChild);
						div_body.appendChild(div_content);
						card.appendChild(div);
						card.appendChild(div_body);
						
						null !== e && (t.mainContainer.innerHTML = ""), (t.mainContainer.appendChild(card)), t.loader.classList.add("is-hidden")
					})["catch"](function(e) {
			...
			p = function(e) {
				function t() {
					...
					return u.addRoute("/", new d["default"]),
						u.addRoute("/resources", new d["default"]),
						u.addRoute("/types", new d["default"]),
						u.addRoute("/labels", new d["default"]),
